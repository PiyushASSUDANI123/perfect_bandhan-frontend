...
class LanguageProvider extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'found_elite': 'FOUND ELITE PROFILES',
      'search_engine': 'SEARCH ENGINE',
      'define_ideal_match': 'DEFINE YOUR IDEAL MATCH',
      'eg_city': 'e.g., London, New York, Kolkata',
      'exclude_nukh': 'Enter surname/nukh to exclude',
      'profile_visits': 'Profile\nVisits',
      'shortlisted_profiles': 'Shortlisted\nProfiles',
      'contact_views': 'Contact\nViews',
      'view_all': 'View all',
      'no_title_yet': 'No {title} yet.',
      'active_conversations': 'YOUR ACTIVE CONVERSATIONS',
      'chat_locked': 'Chat Locked',
      'chat_locked_desc': 'Send an interest to start chatting.',
      'you': 'You',
      'photo': 'Photo',
      ...
      'lives_in': 'Lives In',
      'complexion_weight': 'Complexion & Weight',
      'bio': 'Bio',
      'job_post': 'Job Post',
      'district': 'District',
      'proper_address': 'Proper Address',
      ...
      'other_grah': 'Other Grah / Dosha',
      'family_type': 'Family Type',
      'siblings_details': 'Siblings Details',
      'father': 'Father',
      'mother': 'Mother',
      'profession': 'Profession',
      'profile_updated': 'Profile Updated',
      'update_failed': 'Update Failed',
      'astrological_intel': 'Astrological Intel',
      'family_intel': 'Family Intel',
      'professional_intel': 'Professional Intel',
    ...
    'hi': {
      ...
      // ── Additional App Strings ─────────────────────────────────────────────
      'maximum_age': 'अधिकतम आयु',
      'all_locations': 'सभी स्थान',
      'search_results': 'खोज परिणाम',
      'found_elite': 'एलीट प्रोफाइल मिले',
      'search_engine': 'सर्च इंजन',
      'define_ideal_match': 'अपनी आदर्श पसंद चुनें',
      'eg_city': 'उदा., लंदन, न्यूयॉर्क, कोलकाता',
      'exclude_nukh': 'निकालने के लिए सरनेम/नख दर्ज करें',
      'profile_visits': 'प्रोफ़ाइल\nविज़िट',
      'shortlisted_profiles': 'शॉर्टलिस्ट\nकिए गए',
      'contact_views': 'संपर्क\nदेखे गए',
      'view_all': 'सभी देखें',
      'no_title_yet': 'अभी तक कोई {title} नहीं है।',
      'active_conversations': 'आपकी सक्रिय बातचीत',
      'chat_locked': 'चैट लॉक है',
      'chat_locked_desc': 'चैट शुरू करने के लिए रुचि भेजें।',
      'you': 'आप',
      'photo': 'फोटो',
      'type_message': 'एक संदेश टाइप करें...',
      'message_sent_success': 'संदेश सफलतापूर्वक भेजा गया',
      'failed_to_send': 'भेजने में विफल',
      'limit_reached': 'मासिक सीमा पूरी हो गई',

      // ── Profile details & Account ──────────────────────────────────────────
      'delete_account': 'खाता हटाएं',
      'delete_account_desc': 'यह स्थायी है और इसे वापस नहीं लिया जा सकता।\nआपका सारा डेटा, फ़ोटो और कनेक्शन हटा दिए जाएंगे।',
      'account_deleted': 'खाता हटा दिया गया',
      'deletion_failed': 'खाता हटाने में विफल',
      'password_updated': 'पासवर्ड अपडेट किया गया',
      'update_profile': 'प्रोफ़ाइल अपडेट करें',
      'age_height': 'उम्र और ऊंचाई',
      'lives_in': 'रहते हैं',
      'complexion_weight': 'रंग और वजन',
      'bio': 'बायो',
      'job_post': 'नौकरी का पद',
      'district': 'जिला',
      'proper_address': 'सही पता',
      ...
      'other_grah': 'अन्य ग्रह / दोष',
      'family_type': 'परिवार का प्रकार',
      'siblings_details': 'भाई-बहनों का विवरण',
      'father': 'पिता',
      'mother': 'माता',
      'profession': 'पेशा',
      'profile_updated': 'प्रोफ़ाइल अपडेट की गई',
      'update_failed': 'अपडेट विफल',
      'astrological_intel': 'ज्योतिषीय जानकारी',
      'family_intel': 'पारिवारिक जानकारी',
      'professional_intel': 'व्यावसायिक जानकारी',
